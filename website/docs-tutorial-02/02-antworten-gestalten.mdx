...
<svg viewBox="0 0 720 260" width="100%" role="img"
  ...
  <g transform="translate(40,118)">
    ...
    <text x="16" y="41" fontSize="13" fontFamily="var(--ifm-font-family-monospace)"
          fill="var(--ifm-font-color-base)">Location: /api/v1/guestbook/1</text>
...
Für die letzten beiden Zeilen brauchst du zwei Aufrufe, die noch nicht in deiner `requests.http` stehen. Ergänze sie:
...
DELETE http://localhost:8080/api/v1/guestbook
```
...
:::note Falls Postman nicht installiert ist
Im Klassenraum ist es meist schon da. Sonst gibt es das Programm kostenlos unter [postman.com/downloads](https://www.postman.com/downloads/); ein Konto brauchst du dafür nicht.

Geht die Installation nicht, ist das kein Beinbruch: Alles, was hier geübt wird, kannst du auch mit deiner `.http`-Datei. Lies die Aufgabe dann und arbeite weiter.
:::
