...
<svg viewBox="0 0 720 260" width="100%" role="img"
  ...
  <text x="34" y="24" fontSize="15" fontWeight="800" fontFamily="var(--ifm-font-family-monospace)"
        fill="var(--ifm-color-primary)">ResponseEntity</text>
  ...
  <g transform="translate(40,54)">
    ...
    <text x="624" y="32" textAnchor="end" fontSize="11.5" fill="var(--ifm-color-emphasis-600)">was ist passiert?</text>
  </g>
  ...
  <g transform="translate(40,118)">
    ...
    <text x="624" y="32" textAnchor="end" fontSize="11.5" fill="var(--ifm-color-emphasis-600)">Angaben über die Antwort</text>
  </g>
  ...
  <g transform="translate(40,182)">
    ...
    <text x="624" y="32" textAnchor="end" fontSize="11.5" fill="var(--ifm-color-emphasis-600)">der Inhalt</text>
  </g>
</svg>
...
<svg viewBox="0 0 720 250" width="100%" role="img"
  ...
  <text x="16" y="26" fontSize="13" fontWeight="700" fill="var(--ifm-color-success-dark)">Eintrag gefunden</text>
  ...
  <g transform="translate(16,40)">
    ...
    <text x="75" y="45" textAnchor="middle" fontSize="13" fontWeight="700" fill="var(--ifm-color-success-dark)">der Eintrag</text>
  </g>
  ...
  <g transform="translate(254,40)">
    ...
    <text x="85" y="45" textAnchor="middle" fontSize="13" fontWeight="700" fill="var(--ifm-color-success-dark)">200-Antwort</text>
  </g>
  ...
  <g transform="translate(532,40)">
    <rect width="172" height="58" rx="9" fill="var(--ifm-color-success-dark)"/>
  ...
  <text x="16" y="152" fontSize="13" fontWeight="700" fill="var(--ifm-color-danger-dark)">nichts gefunden</text>
  ...
  <g transform="translate(532,166)">
    <rect width="172" height="58" rx="9" fill="var(--ifm-color-danger-dark)"/>
