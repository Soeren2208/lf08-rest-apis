...
- Die `404`-Behandlung ist weg. Nicht weggefallen, sondern an die zwei Stellen gewandert, an die sie gehört: die Regel in den Service, die Übersetzung in den `ApiExceptionHandler`.
