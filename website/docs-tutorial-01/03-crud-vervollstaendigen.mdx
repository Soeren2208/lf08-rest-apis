...
{/* Pflegehinweis: Die Task-Ids (ab03-a5 in Aufgabe 4, ab03-a4-* in Aufgabe 5)
    stammen aus der frueheren Reihenfolge, in der die Idempotenz-Aufgabe vor der
    Request-Sammlung stand. Sie sind absichtlich unveraendert geblieben: An ihnen
    haengt der Abhak-Zustand im Browser der Schueler. */}
