...
**Die Ursache ist grundsätzlicher Art:** Deine Entität `Person` ist gleichzeitig das, was von außen hereinkommt. Der Client bestimmt damit Felder, die ihm nicht gehören. Die saubere Lösung ist ein eigenes Objekt für die Anfrage, in dem `id` schlicht nicht vorkommt — ein **DTO**. Darauf kommen wir im nächsten Tutorial zurück.
