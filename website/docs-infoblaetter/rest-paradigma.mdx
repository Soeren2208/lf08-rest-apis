...
<svg viewBox="0 0 720 400" width="100%" role="img"
  ...
  <g transform="translate(376,156)">
    ...
    <text x="14" y="26" fontSize="13" fontWeight="700" fill="var(--ifm-color-primary)">Stufe 2</text>
    ...
    <text x="14" y="184" fontSize="11.5" fontWeight="700" fill="var(--ifm-color-primary)">Das bauen wir</text>
    <text x="14" y="201" fontSize="11.5" fontWeight="700" fill="var(--ifm-color-primary)">in diesen Tutorials</text>
  </g>
  ...
  <g transform="translate(556,100)">
    ...
    <text x="14" y="140" fontSize="11" fontWeight="700" fill="var(--ifm-color-emphasis-600)">In der Praxis</text>
    <text x="14" y="156" fontSize="11" fontWeight="700" fill="var(--ifm-color-emphasis-600)">kaum verbreitet</text>
  </g>

  {/* Markierung "hier steht die Praxis" */}
  <g transform="translate(376,104)">
    <rect width="164" height="34" rx="17" fill="var(--ifm-color-primary)"/>
