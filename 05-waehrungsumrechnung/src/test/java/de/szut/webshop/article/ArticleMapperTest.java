...
class ArticleMapperTest {
    ...
    @Test
    @DisplayName("setzt bei der umgerechneten Variante Preis und Waehrung aus den Parametern ein")
    void toDtoWithConvertedPrice() {
        Article article = new Article();
        article.setId(1L);
        article.setDesignation("Schraube M6");
        article.setPrice(new BigDecimal("0.45"));
        ...
        ArticleDto dto = mapper.toDto(article, "USD", new BigDecimal("0.49"));

        assertThat(dto.price()).isEqualByComparingTo("0.49");
